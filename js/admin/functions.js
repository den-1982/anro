...
$(function(){
	$('img').error(function(){
		// this.src = '/img/i/loading_mini.gif';
	});
});
...
;$(function(){
	...
	$('[data-mask="int"]').mask("9?999999999999",{ placeholder:""});
	$('[data-mask="price"]').mask("$?$$$$$$$$$$$",{ placeholder:"" });
	$('[data-mask="code"]').mask("99999",{ placeholder:"_" });
	$('[data-mask="phone"]').mask("+38 (999) 999-99-99",{ placeholder:"_" });
	$('[data-mask="_phone"]').mask("(0~9) 999-99-99",{ placeholder:"_" });
...
$(document).on('click', '[data-delete]', function(e){
	...
	var _this = $(this),
		confirm = $('<div class="fm-confirm">'+
						'Удалить: <b>'+ _this.attr('data-delete') +'?</b>'+
						'<br>'+
